import './libs/snap.svg.js';
import './libs/jquery-2.1.1.min.js';
import './libs/jquery-ui-1.11.min.js';
// import './build/lechef.css';
...
(function() {
  ...
  var exer = new CircuitExercise({element: $(".circuit-exercise-container"),
  input: ["x", "y"],
  output: "g",
